...
// sie, a wynik jego dzialania byl taki sam jak podany na koĹ„cu tego
// pliku.
...
int main ()
{
  ...
  Lokaj<&Pomieszczenie::zetrzyj_kurze>(zamknietaLazienka); // Pomieszczenie lazienka jest zamkniÄ™te.
  ...
  Lokaj<&Pomieszczenie::umyj_podloge>(zamknietaLazienka); // Pomieszczenie lazienka jest zamkniÄ™te.
...
Scieram kurze w pomieszczeniu: kuchnia
Scieram kurze w pomieszczeniu: lazienka
Pomieszczenie lazienka jest zamkniÄ™te.
